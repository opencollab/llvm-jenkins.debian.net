...
DISTROS=("debian:trixie" "debian:bookworm"  "debian:buster" "debian:bullseye"  "debian:testing" "debian:unstable" "ubuntu:20.04" "ubuntu:22.04" "ubuntu:24.04" "ubuntu:24.10" "ubuntu:25.04" "ubuntu:25.10")
